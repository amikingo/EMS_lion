                    ...
                    <div class="col-sm-12">
                        <div class="page-header float-left">
                            <div class="page-title">
                                <h4>Student Full Name: <b><?php echo  $rowStd['firstName'].' '.$rowStd['lastName'].' '.$rowStd['otherName'];?></b></h4>
                                <h4>ID Number: <b><?php echo $rowStd['matricNo'];?>&nbsp;&nbsp;&nbsp;&nbsp; Semester: <b><?php echo $rowSemester['semesterName'];?> Semester</b></h4>
                                <h4>Program: <b><?php echo $rowLevel['levelName'];?>&nbsp;&nbsp;&nbsp;&nbsp; Academic Year: <b><?php echo $rowSession['sessionName'];?></b></h4>
                            </div>
                        </div>
                    </div>
                </div>
