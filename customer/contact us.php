...
<head>
  ...
  <title>Contact Us-Lion Security Services </title>
...
<body>
  ...
  <li class="active"><a href="contact us.php"><button type="button" class="btn btn-primary">Contact Us</button></a></li>
  <li class="drop-down">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-12 pt-4 pt-lg-2 order-2 order-lg-8 content">
            <p>
            <h3>Top and Number one in All over Ethiopia</h3>
        ...
        <div class="row">
          ...
          <br><br>
            ...
            <p>
              ...
              <strong>Fax:</strong> 01 116 553573<br>
              <strong>Email:</strong>  lionsecurity@info.et<br>
              <strong>Website:</strong> www.lionsecurityservices.com<br>
  ...
  <footer id="footer">
    ...
    <div class="container d-md-flex py-4">
      <div class="mr-md-auto text-center text-md-left">
        <div class="copyright">
        &copy; <strong><span>Lion Security Services</span></strong> - <?php echo date('Y');?> - Developed By REHA TECH
        </div>
        <div class="credits">
        </div>
      </div>
