...
<body>
  ...
  <li class="active"><a href="About us.php"><button type="button" class="btn btn-primary">About Us</button></a></li>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-12 pt-4 pt-lg-2 order-2 order-lg-8 content">
            <p>
...
Lion Security Service PLC commenced its service with very few customers (which were not more than 3 in number) and with 41 workforces, in the capital Addis Ababa. As the Company is working with many governmental agencies, non-governmental organizations, private companies and households in a well-established system and organization it is gaining the highest reputation in the industry
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2> Missions of Lion Security Services</h2>
          <p> Our Missions</p>
        </div>
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <p>
              <ui>
              <li>The values of Lion Security Service PLC are considering the customer like a king, integrity, accountability, transparency, obedience, confidentiality, respect, alertness and rapidity. </li>
              <li>The mission of the Company is to safeguard the life of its customers, their property and other valuable assets using competent manpower, modern working systems and technologies from the threat of any sort of crime and disasters in accordance with the law of the Country. </li>
              <li>The vision of the Company is to see governmental organizations, international and regional institutions, business firms, private individuals, households etc. </li>
              <li>in Ethiopia and Africa at large, fulfilling their vision and missions being free from criminal threats of any sort.</li>
              <li>If it occurred, in case, to mitigate its effect by working with governmental and private security agencies like the Police. </li>
              <li>Engage in good manarism and willfull to create a better security to the customers and the society. </li>
              </ui>
      ...
      <div class="container">
        ...
        <div class="row counters">
          ...
          <div class="col-lg-3 col-6 text-center">
            <span data-toggle="counter-up"style="color: #007bff;">1069</span>
            <p>Students</p>
          </div>

          <div class="col-lg-3 col-6 text-center">
            <span data-toggle="counter-up"style="color: #007bff;">9</span>
            <p>Departments</p>
          </div>

          <div class="col-lg-3 col-6 text-center">
            <span data-toggle="counter-up"style="color: #007bff;">12</span>
            <p>Events</p>
          </div>

          <div class="col-lg-3 col-6 text-center">
            <span data-toggle="counter-up"style="color: #007bff;">5</span>
            <p>Faculties</p>
          </div>
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            <h4>Useful Links</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="index.php" style="color:black !important;">Home</a></li>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        <div class="copyright">
        &copy; <strong><span>Lion Security Service PLC</span></strong> - <?php echo date('Y');?> - Developed By REHA TECH
        </div>
        <div class="credits">
        </div>
      </div>
