...
if (isset($_POST["signup"])) {
  ...
  $file = mysqli_real_escape_string($conn, $_POST["signup_file"]);
  ...
  if ($password !== $cpassword) {
    ...
    $sql = "INSERT INTO users (full_name, email, password, token, status, file) VALUES ('$full_name', '$email', '$password', '$token', '1','file')";
    ...
    <div class="forms-container">
      <div class="signin-signup">
        ...
        <form action="" class="sign-up-form" method="post">
          ...
          <div class="input-field">
            <i class="fas fa-envelope"></i>
            <input type="file" placeholder="File" name="signup_file"  value="<?php echo $_POST["signup_file"]; ?>" required />
