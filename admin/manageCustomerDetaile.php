...
{               ?>
     ...
     <td><a href="editCustomerDetaile.php?editid=<?php echo htmlentities ($row->id);?>" title="View"><i class="fa fa-edit fa-1x"></i></a></td>             
<!-- <td><a onclick="return confirm('Are you sure you want to delete?')" href="manageCustomer.php?delid=<// echo htmlentities($row->id);?>" title="Delete Customer"><i class="fa fa-trash fa-1x"></i></a></td> -->
                </tr>
