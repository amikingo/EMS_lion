        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form role="form" method="post" name="printReport" action="print/printStoreKeeperPreExpireDateSt/print.php">
              <?php
$fdate=$_POST['fromdate'];
$tdate=$_POST['todate'];

?>
<h5 align="center" style="color:blue">Report from <?php echo $fdate?> to <?php echo $tdate?> By <?php echo "pre-Expire Date";?></h5>
