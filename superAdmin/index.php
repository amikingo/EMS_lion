                        ...
                        <div class="card text-white bg-secondary">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    ...
                                    <p class="text-light mt-1 m-0">Comp. Result</p>
                                </div><!-- /.card-left -->
                        ...
                        <div class="card text-white bg-info">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    ...
                                    <p class="text-light mt-1 m-0">Progeram</p>
                                </div><!-- /.card-left -->
                        ...
                        <div class="card text-white bg-primary">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    ...
                                    <p class="text-light mt-1 m-0">Distinction No.</p>
                                </div><!-- /.card-left -->
                        ...
                        <div class="card text-white bg-flat-color-6">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    ...
                                    <p class="text-light mt-1 m-0">Upper Credit</p>
                                </div><!-- /.card-left -->
                        ...
                        <div class="card text-white bg-flat-color-4">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    ...
                                    <p class="text-light mt-1 m-0">Lower Credit</p>
                                </div><!-- /.card-left -->
                        ...
                        <div class="card text-white bg-flat-color-2">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    ...
                                    <p class="text-light mt-1 m-0">Passed No.</p>
                                </div><!-- /.card-left -->
                        ...
                        <div class="card text-white bg-danger">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    ...
                                    <p class="text-light mt-1 m-0">Failed No.</p>
                                </div><!-- /.card-left -->
