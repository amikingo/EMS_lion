                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <label for="cc-exp" class="control-label mb-1">Course Chr.Hrs.</label>
                                                        <input id="" name="courseUnit" type="text" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration" data-val-cc-exp="Please enter a valid month and year" placeholder="Course Cr.Hrs">
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
